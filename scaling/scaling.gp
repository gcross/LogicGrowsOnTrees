...
plot 'N_19' u 1:2 lc 1 title 'N=19 actual', x >= 4 && x <= 256 ? 1700*4/x : 0/0 lc 1 title 'N=19 ideal', \
     'N_18' u 1:2 lc 3 title 'N=18 actual', x >= 1 && x <= 256 ? 840/x    : 0/0 lc 3 title 'N=18 ideal', \
